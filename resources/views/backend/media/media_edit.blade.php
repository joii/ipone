                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <option value="{{ $brand->id }}"  {{ $brand->id == $media->brand_id ? 'selected': '' }}>{{ $brand->brand_name_en }}</option>	
                                        @endforeach
                                    </select>
                                        @error('brand_id') 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <option value="{{ $category->id }}"  {{ $category->id == $media->category_id ? 'selected': '' }}>{{ $category->category_name_en }}</option>	
                                        @endforeach
                                        </select>
                                        @error('category_id') 
                                        <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <option value="{{ $subcategory->id }}"  {{ $subcategory->id == $media->subcategory_id ? 'selected': '' }}>{{ $subcategory->subcategory_name_en }}</option>	
                                        @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <option value="{{ $product->id }}"  {{ $product->id == $media->product_id ? 'selected': '' }}>{{ $product->product_name_en }}</option>	
                                        @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                        <input type="text" name="media_title_th" class="form-control" value="{{ $media->media_title_th }}">
                                        @error('media_title_th')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                        <input type="text" name="media_title_en" class="form-control"  value="{{ $media->media_title_en }}">
                                        @error('media_title_en')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                        <input type="text" name="media_title_ch" class="form-control"  value="{{ $media->media_title_ch }}" >
                                        @error('media_title_ch')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                        <input name="media_url" type="text" class="form-control" value="{{ $media->media_url }}" >
                                        @error('media_url') 
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror 
                                        </div>
                                    ...
                                    <div class="form-group">
                                    <input name="status" type="radio" id="status1" value="1" class="radio-col-success" {{ $media->status == 1 ? 'checked': '' }}>
                                    <label for="status1">Active</label>
                                    <input name="status" type="radio" id="status2" value="0" class="radio-col-danger" {{ $media->status == 0 ? 'checked': '' }}>
