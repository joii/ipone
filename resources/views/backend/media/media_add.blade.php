                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                        <input type="text" name="media_title_th" class="form-control" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                        <input type="text" name="media_title_en" class="form-control" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                        <input type="text" name="media_title_ch" class="form-control" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                        <input name="media_url" type="text" class="form-control" >
                                        @error('media_url') 
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror 
                                        </div>
