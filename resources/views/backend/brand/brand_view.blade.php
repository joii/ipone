...
@section('admin')
    ...
    <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
                ...
                <div class="float-rught"><a href="{{ route('brand.add')}}" class="btn btn-outline btn-dark mb-5">Add New</a></div>
			</div>
		</div>	  
                            ...
                            <table id="complex_header" class="table table-striped table-bordered display dataTable" style="width: 100%;" role="grid" aria-describedby="complex_header_info">
								<thead>
									<tr role="row">
                                        ...
                                        <th colspan="1" rowspan="2" class="sorting_asc" tabindex="0" aria-controls="complex_header" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="20%" >Logo</th>
									...
									<tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="complex_header" rowspan="1" colspan="1" aria-label="E-mail: activate to sort column ascending" >CH</th>
									</tr>
								</thead>
								<tbody>	
 ...
 <a href="{{ route('brand.delete',$brand->id) }}" class="btn btn-danger" title="Delete Data" id="delete">
 	<i class="fa fa-trash"></i></a>
										...
										<td class="sorting_1"><img src="{{ asset($brand->brand_logo) }}" style="width: 80px;"> </td>
										<td>{{$brand->brand_name_th}}</td>
										<td>{{$brand->brand_name_en}}</td>
										<td>{{$brand->brand_name_ch}}</td>
